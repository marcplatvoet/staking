...
const Transfertokens = ({
	...
	return (
		<div>
			...
			<div className="card col-sm-6 bg-royalties">
			...
			<div className="row">
				<div className="col-lg-6 card col-sm-8 bg-royalties">
